          ...
          <div className="-mt-4 -ml-8 flex flex-wrap justify-between lg:-ml-4">
            <NavLink href="https://www.classykangaroos.com/" target="blank">
              <div className="mt-4 ml-8 flex flex-grow flex-shrink-0 lg:flex-grow-0 lg:ml-4">
                <img className="h-20" src="/customers/classy.png" alt="logo" />
              </div>
            </NavLink>

            <NavLink href="https://metafighter.com/" target="blank">
              <div className="mt-4 ml-8 flex flex-grow flex-shrink-0 lg:flex-grow-0 lg:ml-4">
                <img className="h-20" src="/customers/meta.png" alt="logo" />
              </div>
            </NavLink>

            <NavLink href="https://cryptomonkeys.me/" target="blank">
              <div className="mt-4 ml-8 flex flex-grow flex-shrink-0 lg:flex-grow-0 lg:ml-4">
                <img className="h-20" src="/customers/monkeys.png" alt="logo" />
              </div>
            </NavLink>

            <NavLink href="https://deliqfinance.com/" target="blank">
              <div className="mt-4 ml-8 flex flex-grow flex-shrink-0 lg:flex-grow-0 lg:ml-4">
                <img className="h-20" src="/customers/deliq.png" alt="logo" />
              </div>
            </NavLink>

            <NavLink href="https://projectmerge.org/" target="blank">
              <div className="mt-4 ml-8 flex flex-grow flex-shrink-0 lg:flex-grow-0 lg:ml-4">
                <img className="h-20" src="/customers/merge.webp" alt="logo" />
              </div>
            </NavLink>
