...
export default function Customers() {
  return (
    <div
      id="customers"
      className="bg-gradient-to-t from-indigo-500 via-primary to-secondary"
    >
