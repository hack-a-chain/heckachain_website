        ...
        <g>
          <g>
            <linearGradient
              ...
              y2={616}
            >
              <stop offset={0} style={{ stopColor: "#6EFFE2" }} />
...
3jXbAAAAAElFTkSuQmCC"
          ...
          <g id="d-appswrapper">
            <g id="d-app">
              ...
              <g>
                <linearGradient
                  ...
                  gradientTransform="matrix(1 0 0 -1 0 1900)"
                >
                  <stop offset={0} style={{ stopColor: "#6b68ff" }} />
                  <stop offset="0.2302" style={{ stopColor: "#7674fc" }} />
                  <stop offset="0.4367" style={{ stopColor: "#817fff" }} />
                  <stop offset="0.634" style={{ stopColor: "#8b89ff" }} />
                  <stop offset="0.8245" style={{ stopColor: "#9997FF" }} />
                  <stop offset={1} style={{ stopColor: "#acaaff" }} />
                </linearGradient>
                <path
                  fill="url(#SVGID_9_)"
            ...
            <g>
              ...
              />
              <g>
                <circle fill="#9997FF" cx="553.5" cy="364.8" r="1.5" />
                <circle fill="#9997FF" cx="518.5" cy="307.8" r="0.5" />
                <circle fill="#FFFFFF" cx="600.2" cy="379.4" r="0.7" />
                <circle fill="#9997FF" cx="581.8" cy="310.5" r="0.7" />
                ...
                <circle fill="#9997FF" cx="576.7" cy="339.6" r="0.7" />
                ...
                <circle fill="#9997FF" cx="604.2" cy="357.9" r="1.4" />
                <circle fill="#FFFFFF" cx="521.8" cy={341} r="0.7" />
                <circle fill="#9997FF" cx="506.9" cy={322} r="0.7" />
                <circle fill="#9997FF" cx={513} cy="361.5" r="0.7" />
                <circle fill="#9997FF" cx="554.8" cy="313.4" r={1} />
                <circle fill="#9997FF" cx="539.3" cy="341.7" r="1.4" />
          ...
          <g id="d-apps2wrapper">
            ...
            <g id="d-apps2">
              ...
              <g>
                <linearGradient
                  ...
                  gradientTransform="matrix(1 0 0 -1 0 1900)"
                >
                  <stop offset={0} style={{ stopColor: "#9997FF" }} />
                  <stop offset="0.2302" style={{ stopColor: "#9997FF" }} />
                  <stop offset="0.4367" style={{ stopColor: "#9997FF" }} />
                  <stop offset="0.634" style={{ stopColor: "#9997FF" }} />
                  <stop offset="0.8245" style={{ stopColor: "#9997FF" }} />
                  <stop offset={1} style={{ stopColor: "#9997FF" }} />
                </linearGradient>
                <path
            ...
            <g>
              ...
              />
              <g>
                <circle fill="#9997FF" cx="1249.2" cy="825.7" r="1.5" />
                <circle fill="#9997FF" cx="1214.2" cy="768.7" r="0.5" />
                <circle fill="#FFFFFF" cx="1295.9" cy="840.3" r="0.7" />
                <circle fill="#9997FF" cx="1277.5" cy="771.4" r="0.7" />
                ...
                <circle fill="#9997FF" cx="1272.4" cy="800.5" r="0.7" />
                ...
                <circle fill="#9997FF" cx={1300} cy="818.8" r="1.4" />
                <circle fill="#FFFFFF" cx="1217.5" cy="801.9" r="0.7" />
                <circle fill="#9997FF" cx="1202.6" cy="782.9" r="0.7" />
                <circle fill="#9997FF" cx="1208.8" cy="822.4" r="0.7" />
                <circle fill="#9997FF" cx="1250.5" cy="774.3" r={1} />
                <circle fill="#9997FF" cx="1235.1" cy="802.6" r="1.4" />
...
RK5CYII="
		...
		555.6,608.9 		"
            ...
            >
              ...
              <stop
                offset="0.2113"
                style={{ stopColor: "#c7fcf1", stopOpacity: "0.2113" }}
              />
              <stop
                offset="0.4448"
                style={{ stopColor: "#b2ffef", stopOpacity: "0.4448" }}
              />
              <stop
                offset="0.6617"
                style={{ stopColor: "#8effe8", stopOpacity: "0.6617" }}
              />
              <stop
                offset="0.8535"
                style={{ stopColor: "#6EFFE2", stopOpacity: "0.8535" }}
              />
              <stop offset={1} style={{ stopColor: "#6EFFE2" }} />
            </linearGradient>
            <polygon
          ...
          <g id="redblocksparticles">
            <g>
              ...
              >
                <stop
                  offset={0}
                  style={{ stopColor: "#6EFFE2", stopOpacity: 0 }}
                />
                <stop offset={1} style={{ stopColor: "#6EFFE2" }} />
              </linearGradient>
              <polygon
			...
			1141.3,409 			"
              ...
              />
              <g>
                <circle cx="1115.2" cy="508.7" r="1.5" fill="#9997FF" />
                <circle cx="1080.2" cy="451.7" r="0.5" fill="#9997FF" />
                <circle cx="1161.9" cy="523.3" r="0.7" fill="#FFFFFF" />
                <circle cx="1143.5" cy="454.4" r="0.7" fill="#9997FF" />
                ...
                <circle cx="1138.4" cy="483.5" r="0.7" fill="#9997FF" />
                ...
                <circle cx={1166} cy="501.8" r="1.4" fill="#9997FF" />
                <circle cx="1083.5" cy="484.9" r="0.7" fill="#FFFFFF" />
                <circle cx="1068.6" cy="465.9" r="0.7" fill="#9997FF" />
                <circle cx="1074.8" cy="505.4" r="0.7" fill="#9997FF" />
                <circle cx="1116.5" cy="457.3" r={1} fill="#9997FF" />
                <circle cx="1101.1" cy="485.6" r="1.4" fill="#9997FF" />
            ...
            <g>
              ...
              />
              <g>
                <circle cx="799.2" cy="696.7" r="1.5" fill="#9997FF" />
                <circle cx="764.2" cy="639.7" r="0.5" fill="#9997FF" />
                <circle cx="845.9" cy="711.3" r="0.7" fill="#FFFFFF" />
                <circle cx="827.5" cy="642.4" r="0.7" fill="#9997FF" />
                ...
                <circle cx="822.4" cy="671.5" r="0.7" fill="#9997FF" />
                ...
                <circle cx={850} cy="689.8" r="1.4" fill="#9997FF" />
                <circle cx="767.5" cy="672.9" r="0.7" fill="#FFFFFF" />
                <circle cx="752.6" cy="653.9" r="0.7" fill="#9997FF" />
                <circle cx="758.8" cy="693.4" r="0.7" fill="#9997FF" />
                <circle cx="800.5" cy="645.3" r={1} fill="#9997FF" />
                <circle cx="785.1" cy="673.6" r="1.4" fill="#9997FF" />
            ...
            <g>
              ...
              >
                <stop
                  offset={0}
                  style={{ stopColor: "#9997FF", stopOpacity: 0 }}
                />
                <stop offset={1} style={{ stopColor: "#9997FF" }} />
              </linearGradient>
              <polygon
              ...
              />
              <g>
                <circle cx="640.2" cy="789.7" r="1.5" fill="#9997FF" />
                <circle cx="605.2" cy="732.7" r="0.5" fill="#9997FF" />
                <circle cx="686.9" cy="804.3" r="0.7" fill="#FFFFFF" />
                <circle cx="668.5" cy="735.4" r="0.7" fill="#9997FF" />
                ...
                <circle cx="663.4" cy="764.5" r="0.7" fill="#9997FF" />
                ...
                <circle cx={691} cy="782.8" r="1.4" fill="#9997FF" />
                <circle cx="608.5" cy="765.9" r="0.7" fill="#FFFFFF" />
                <circle cx="593.6" cy="746.9" r="0.7" fill="#9997FF" />
                <circle cx="599.8" cy="786.4" r="0.7" fill="#9997FF" />
                <circle cx="641.5" cy="738.3" r={1} fill="#9997FF" />
                <circle cx="626.1" cy="766.6" r="1.4" fill="#9997FF" />
            ...
            <g>
              ...
              />
              <g>
                <circle cx="485.2" cy="882.7" r="1.5" fill="#9997FF" />
                <circle cx="450.2" cy="825.7" r="0.5" fill="#9997FF" />
                <circle cx="531.9" cy="897.3" r="0.7" fill="#FFFFFF" />
                <circle cx="513.5" cy="828.4" r="0.7" fill="#9997FF" />
                ...
                <circle cx="508.4" cy="857.5" r="0.7" fill="#9997FF" />
                ...
                <circle cx={536} cy="875.8" r="1.4" fill="#9997FF" />
                <circle cx="453.5" cy="858.9" r="0.7" fill="#FFFFFF" />
                <circle cx="438.6" cy="839.9" r="0.7" fill="#9997FF" />
                <circle cx="444.8" cy="879.4" r="0.7" fill="#9997FF" />
                <circle cx="486.5" cy="831.3" r={1} fill="#9997FF" />
                <circle cx="471.1" cy="859.6" r="1.4" fill="#9997FF" />
		...
		l-0.8-1.3L1524.4,178.1z"
          ...
          <g id="firstBlock">
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop offset={0} style={{ stopColor: "#6764fc" }} />
              <stop offset="0.2857" style={{ stopColor: "#7676fc" }} />
              <stop offset="0.75" style={{ stopColor: "#8583fc" }} />
              <stop offset={1} style={{ stopColor: "#9997FF" }} />
            </linearGradient>
            <polygon
              fill="url(#SVGID_49_)"
            ...
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop offset={0} style={{ stopColor: "#aeadff" }} />
              <stop offset="0.1701" style={{ stopColor: "#9997FF" }} />
              <stop offset="0.4158" style={{ stopColor: "#8583fc" }} />
              <stop offset="0.6441" style={{ stopColor: "#7676fc" }} />
              <stop offset="0.8458" style={{ stopColor: "#6764fc" }} />
              <stop offset={1} style={{ stopColor: "#9997FF" }} />
            </linearGradient>
            <polygon
              fill="url(#SVGID_50_)"
            ...
            >
              <stop offset={0} style={{ stopColor: "#9997FF" }} />
              <stop offset="5.850000e-02" style={{ stopColor: "#9997FF" }} />
              <stop offset="0.6415" style={{ stopColor: "#6764fc" }} />
              <stop offset={1} style={{ stopColor: "#9997FF" }} />
            </linearGradient>
            <polygon
              fill="url(#SVGID_51_)"
            ...
            >
              <stop offset={0} style={{ stopColor: "#FFFFFF" }} />
              <stop offset="0.2713" style={{ stopColor: "#9a99ff" }} />
              <stop offset="0.5184" style={{ stopColor: "#8987ff" }} />
              <stop offset="0.7299" style={{ stopColor: "#7f7cff" }} />
              <stop offset="0.8974" style={{ stopColor: "#6866ff" }} />
              <stop offset={1} style={{ stopColor: "#6060ff" }} />
            </linearGradient>
            <polygon
              fill="url(#SVGID_52_)"
          ...
          <g id="blockdis">
            ...
            >
              <stop offset={0} style={{ stopColor: "#9997FF" }} />
              <stop offset="0.2857" style={{ stopColor: "#9997FF" }} />
              <stop offset="0.75" style={{ stopColor: "#9997FF" }} />
              <stop offset={1} style={{ stopColor: "#9997FF" }} />
            </linearGradient>
            <polygon
              fill="url(#SVGID_85_)"
            ...
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop offset={0} style={{ stopColor: "#c0bfff" }} />
              <stop offset="0.1701" style={{ stopColor: "#9896ff" }} />
              <stop offset="0.4158" style={{ stopColor: "#9997FF" }} />
              <stop offset="0.6441" style={{ stopColor: "#5c59ff" }} />
              <stop offset="0.8458" style={{ stopColor: "#7775ff" }} />
              <stop offset={1} style={{ stopColor: "#9997FF" }} />
            </linearGradient>
            <polygon
              fill="url(#SVGID_86_)"
            ...
            >
              <stop offset={0} style={{ stopColor: "#9997FF" }} />
              <stop offset="5.850000e-02" style={{ stopColor: "#9997FF" }} />
              <stop offset="0.6415" style={{ stopColor: "#5c59ff" }} />
              <stop offset={1} style={{ stopColor: "#9997FF" }} />
            </linearGradient>
            <polygon
              fill="url(#SVGID_87_)"
          ...
          <g id="redblocks">
            <g>
              ...
              >
                <stop offset={0} style={{ stopColor: "#6b68ff" }} />
                <stop offset="0.2857" style={{ stopColor: "#6b68ff" }} />
                <stop offset="0.75" style={{ stopColor: "#9997FF" }} />
                <stop offset={1} style={{ stopColor: "#9997FF" }} />
              </linearGradient>
              <polygon
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop offset={0} style={{ stopColor: "#afaefc" }} />
                <stop offset="0.1701" style={{ stopColor: "#9997fc" }} />
                <stop offset="0.4158" style={{ stopColor: "#8482ff" }} />
                <stop offset="0.6441" style={{ stopColor: "#6b68ff" }} />
                <stop offset="0.8458" style={{ stopColor: "#8482ff" }} />
                <stop offset={1} style={{ stopColor: "#9997FF" }} />
              </linearGradient>
              <polygon
                fill="url(#SVGID_50_)"
              ...
              >
                <stop offset={0} style={{ stopColor: "#9997FF" }} />
                <stop offset="5.850000e-02" style={{ stopColor: "#9997FF" }} />
                <stop offset="0.6415" style={{ stopColor: "#6b68ff" }} />
                <stop offset={1} style={{ stopColor: "#9997FF" }} />
              </linearGradient>
              <polygon
                fill="url(#SVGID_51_)"
            ...
            <g>
              ...
              >
                <stop offset={0} style={{ stopColor: "#6b68ff" }} />
                <stop offset="0.2857" style={{ stopColor: "#7c7aff" }} />
                <stop offset="0.75" style={{ stopColor: "#8e8cff" }} />
                <stop offset={1} style={{ stopColor: "#8f8dfc" }} />
              </linearGradient>
              <polygon
                fill="url(#SVGID_55_)"
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop offset={0} style={{ stopColor: "#c3c2fc" }} />
                <stop offset="0.1701" style={{ stopColor: "#acaaff" }} />
                <stop offset="0.4158" style={{ stopColor: "#8e8cff" }} />
                <stop offset="0.6441" style={{ stopColor: "#7c7aff" }} />
                <stop offset="0.8458" style={{ stopColor: "#6b68ff" }} />
                <stop offset={1} style={{ stopColor: "#9997FF" }} />
              </linearGradient>
              <polygon
                fill="url(#SVGID_56_)"
            ...
            <g>
              ...
              >
                <stop offset={0} style={{ stopColor: "#6b68ff" }} />
                <stop offset="0.2857" style={{ stopColor: "#817fff" }} />
                <stop offset="0.75" style={{ stopColor: "#9593ff" }} />
                <stop offset={1} style={{ stopColor: "#a4a3ff" }} />
              </linearGradient>
              <polygon
                fill="url(#SVGID_61_)"
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop offset={0} style={{ stopColor: "#a7a5ff" }} />
                <stop offset="0.1701" style={{ stopColor: "#9593ff" }} />
                <stop offset="0.4158" style={{ stopColor: "#817fff" }} />
                <stop offset="0.6441" style={{ stopColor: "#6b68ff" }} />
                <stop offset="0.8458" style={{ stopColor: "#817fff" }} />
                <stop offset={1} style={{ stopColor: "#9997FF" }} />
              </linearGradient>
              <polygon
                fill="url(#SVGID_62_)"
            ...
            <g>
              ...
              >
                <stop offset={0} style={{ stopColor: "#6b68ff" }} />
                <stop offset="0.2857" style={{ stopColor: "#807efc" }} />
                <stop offset="0.75" style={{ stopColor: "#9896ff" }} />
                <stop offset={1} style={{ stopColor: "#aaa9fc" }} />
              </linearGradient>
              <polygon
                fill="url(#SVGID_67_)"
              ...
              >
                <stop offset={0} style={{ stopColor: "#a7a5ff" }} />
                <stop offset="0.1701" style={{ stopColor: "#aaa9fc" }} />
                <stop offset="0.4158" style={{ stopColor: "#9896ff" }} />
                <stop offset="0.6441" style={{ stopColor: "#807efc" }} />
                <stop offset="0.8458" style={{ stopColor: "#6b68ff" }} />
                <stop offset={1} style={{ stopColor: "#9997FF" }} />
              </linearGradient>
              <polygon
            ...
            <g>
              ...
              >
                <stop offset={0} style={{ stopColor: "#6b68ff" }} />
                <stop offset="0.2857" style={{ stopColor: "#7d7bfc" }} />
                <stop offset="0.75" style={{ stopColor: "#9a99ff" }} />
                <stop offset={1} style={{ stopColor: "#b6b5fc" }} />
              </linearGradient>
              <polygon
                fill="url(#SVGID_73_)"
              ...
              >
                <stop offset={0} style={{ stopColor: "#a7a5ff" }} />
                <stop offset="0.1701" style={{ stopColor: "#9a99ff" }} />
                <stop offset="0.4158" style={{ stopColor: "#8987ff" }} />
                <stop offset="0.6441" style={{ stopColor: "#7d7bfc" }} />
                <stop offset="0.8458" style={{ stopColor: "#6b68ff" }} />
                <stop offset={1} style={{ stopColor: "#9997FF" }} />
            ...
            <g>
              ...
              >
                <stop offset={0} style={{ stopColor: "#6b68ff" }} />
                <stop offset="0.2857" style={{ stopColor: "#817fff" }} />
                <stop offset="0.75" style={{ stopColor: "#8c8afc" }} />
                <stop offset={1} style={{ stopColor: "#9896ff" }} />
              </linearGradient>
              <polygon
                fill="url(#SVGID_79_)"
              ...
              >
                <stop offset={0} style={{ stopColor: "#a7a5ff" }} />
                <stop offset="0.1701" style={{ stopColor: "#9896ff" }} />
                <stop offset="0.4158" style={{ stopColor: "#8c8afc" }} />
                <stop offset="0.6441" style={{ stopColor: "#817fff" }} />
                <stop offset="0.8458" style={{ stopColor: "#6b68ff" }} />
                <stop offset={1} style={{ stopColor: "#9997FF" }} />
              </linearGradient>
              <polygon
            ...
            <g>
              ...
              >
                <stop offset={0} style={{ stopColor: "#a7a5ff" }} />
                <stop offset="0.1701" style={{ stopColor: "#9896ff" }} />
                <stop offset="0.4158" style={{ stopColor: "#7775f9" }} />
                <stop offset="0.6441" style={{ stopColor: "#6b68ff" }} />
                <stop offset="0.8458" style={{ stopColor: "#817fff" }} />
                <stop offset={1} style={{ stopColor: "#9997FF" }} />
              </linearGradient>
      ...
      l0.8-1.2l-2.8-1.8l-0.8,1.2L1447.2,588.7z"
          ...
          <g>
            ...
            >
              ...
              <stop
                offset="0.3874"
                style={{ stopColor: "#6EFFE2", stopOpacity: "0.5873" }}
              />
              <stop
                offset="0.9388"
                style={{ stopColor: "#FFFFFF", stopOpacity: 0 }}
